...
def topf_run(base_points, complex_type = 'alpha', thresh_julia = 0, max_hom_dim = 1.0,  max_rel_quot = 0.1, m = 0.3, weight_exponent = -1, simplex_threshs = (0.1,0.1), simplex_chances = (0.01,0.01), post_exp = 1, n_clusters = 4, draw_reps = False, draw_scaled_vecs = False, draw_final_clustering = False, draw_signatures = False, rep_chance = 1, damping = 0, eigenvector_tresholding = True, eigenvector_threshold = 0.07, clustering_method = 'spectral', clustering_sparseness = 0.0, exponential_interpolation = True, auto_num_clusters = True, max_total_quot = 0.1, quotient_life_times = False, use_eff_resistance = False, raw_signature_heatmaps = False, aggregation_mode = 'mean', scale_vecs = True, eff_resistance_mode = 'weighted', eff_resistance_exponent = 2, verbose = False, process_string = '', max_reps = 100,dim0min_pers_ratio=5, use_weight_tri_kernel = False,thresholding_type = 'linear', add_convex_hull = False, convex_hull_density_coeff =0.1, only_dims = [0,1,2,3], heatmaps_in_one = False):
    """
